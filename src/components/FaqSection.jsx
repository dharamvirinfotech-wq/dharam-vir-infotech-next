...
const FaqSection = ({
  ...
  return (
    <section id={id} className="py-10 sm:py-12 md:py-14 bg-background relative overflow-hidden select-none">
          ...
          {items.map((faq) => {
            ...
            return (
              <motion.div
                ...
                className={`group rounded-2xl border transition-all duration-300 bg-card overflow-hidden ${
                  isOpen
