...
export const heroSlidesData = [
  {
    ...
    headingPrefix: "Digital Products to ",
    headingHighlight: "Scale & Sell Online",
    description:
      "Ensuring the highest return on investment for your bespoke digital products, web platforms, and mobile apps with intuitive UX and high performance.",
    primaryCtaText: "CONTACT TODAY",
  ...
  {
    id: 2,
    categoryTag: "AGENTIC AI & CLOUD",
    headingPrefix: "Apps Built to ",
    headingHighlight: "Perform & Engage Potential",
    description:
      "We build high-concurrency, enterprise-ready web & cloud applications designed for ultra-fast performance, resilient security, and rapid growth.",
    primaryCtaText: "CONTACT TODAY",
    primaryCtaLink: "/contact",
  ...
  {
    id: 3,
    categoryTag: "NEXT-GEN SOLUTIONS",
    headingPrefix: "Build Intelligent Autonomous ",
    headingHighlight: "Systems of Tomorrow",
    description:
      "Empower your business with cutting-edge software architecture, generative AI automation, and intelligent workflows that deliver measurable results.",
    primaryCtaText: "CONTACT TODAY",
    primaryCtaLink: "/contact",
...
export const homeFeaturedProjects = [
  {
    ...
    category: "Desktop & Cloud Software",
    tags: ["Electron", "Node.js", "React", "C++", "AWS"],
    desc: "Engineered high-speed desktop & cloud email conversion suite processing 50+ formats locally with zero data loss and court-admissible Bates stamps.",
    link: "/portfolio/windowsutils",
  },
  {
    title: "FairSearches.com - The Local Business Hub",
    category: "Search Engine & Marketplace",
    tags: ["Next.js", "Node.js", "PostgreSQL", "Elasticsearch", "Redis"],
    desc: "Scalable multi-service directory & search engine connecting millions to verified restaurants, experts, jobs & travel with sub-80ms latency.",
    link: "/portfolio/fairsearches",
  },
  {
    title: "EnviroSure Audit - ESG Compliance Platform",
    category: "CleanTech & Compliance",
    tags: ["React", "Node.js", "PostgreSQL", "Docker", "AWS"],
    desc: "Audit-grade environmental compliance, Scope 1-3 GHG inventories & carbon advisory suite built for strict regulatory assurance.",
    link: "/portfolio/envirosure-audits",
  },
  {
    title: "FinTech Mobile Banking Application",
    category: "Mobile & Security",
    tags: ["React Native", "Node.js", "PostgreSQL", "AWS", "Redis"],
    desc: "High-security digital banking application deployed to 500K+ users with biometric authentication, 99.9% uptime, and end-to-end encryption.",
