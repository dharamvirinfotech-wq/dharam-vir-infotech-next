...
import { Sparkles, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const AiContentGeneration = () => (<PromotionServiceTemplate title="AI Content Generation" subtitle="Leverage AI to create high-quality content at scale." breadcrumb="AI Content Generation" features={[
        { icon: Sparkles, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
