...
import { DollarSign, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const PpcManagement = () => (<PromotionServiceTemplate title="PPC Management" subtitle="Maximize ROI with expert pay-per-click campaign management." breadcrumb="PPC Management" features={[
        { icon: DollarSign, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
