...
import { FileText, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const OnPageSeo = () => (<PromotionServiceTemplate title="On-Page SEO Services" subtitle="Optimize your website content, meta tags, and structure for maximum visibility." breadcrumb="On-Page SEO Services" features={[
        { icon: FileText, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
