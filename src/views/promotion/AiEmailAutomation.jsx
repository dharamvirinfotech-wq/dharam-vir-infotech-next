...
import { Zap, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const AiEmailAutomation = () => (<PromotionServiceTemplate title="AI Email Automation" subtitle="Smart email automation powered by machine learning." breadcrumb="AI Email Automation" features={[
        { icon: Zap, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
