...
const InfluencerMarketing = () => (<PromotionServiceTemplate title="Influencer Marketing" subtitle="Partner with influencers to reach new audiences authentically." breadcrumb="Influencer Marketing" features={[
        { icon: Users, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
