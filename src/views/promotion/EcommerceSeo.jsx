...
import { ShoppingCart, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const EcommerceSeo = () => (<PromotionServiceTemplate title="Ecommerce SEO Services" subtitle="Drive more traffic and sales to your online store with specialized SEO." breadcrumb="Ecommerce SEO Services" features={[
        { icon: ShoppingCart, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
