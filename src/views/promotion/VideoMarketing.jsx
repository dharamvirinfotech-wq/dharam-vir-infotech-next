...
import { Video, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const VideoMarketing = () => (<PromotionServiceTemplate title="Video Marketing" subtitle="Captivate audiences with professional video content strategies." breadcrumb="Video Marketing" features={[
        { icon: Video, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
