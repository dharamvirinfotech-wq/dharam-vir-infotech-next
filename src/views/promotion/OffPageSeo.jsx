...
import { ExternalLink, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const OffPageSeo = () => (<PromotionServiceTemplate title="Off-Page SEO Services" subtitle="Build authority and trust through strategic off-page optimization." breadcrumb="Off-Page SEO Services" features={[
        { icon: ExternalLink, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
