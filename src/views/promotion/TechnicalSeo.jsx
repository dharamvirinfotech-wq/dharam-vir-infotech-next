...
const TechnicalSeo = () => (<PromotionServiceTemplate title="Technical SEO Services" subtitle="Fix site architecture, speed, and crawlability for search engines." breadcrumb="Technical SEO Services" features={[
        { icon: Settings, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
