...
const AiAnalytics = () => (<PromotionServiceTemplate title="AI Analytics & Insights" subtitle="Unlock data-driven decisions with AI-powered analytics." breadcrumb="AI Analytics & Insights" features={[
        { icon: BarChart3, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
