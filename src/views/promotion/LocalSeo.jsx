...
import { MapPin, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const LocalSeo = () => (<PromotionServiceTemplate title="Local SEO Services" subtitle="Dominate local search results and attract nearby customers." breadcrumb="Local SEO Services" features={[
        { icon: MapPin, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
