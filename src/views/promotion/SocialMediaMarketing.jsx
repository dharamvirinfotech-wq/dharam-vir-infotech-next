...
import { Share2, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const SocialMediaMarketing = () => (<PromotionServiceTemplate title="Social Media Marketing" subtitle="Engage audiences and build brand presence across social platforms." breadcrumb="Social Media Marketing" features={[
        { icon: Share2, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
