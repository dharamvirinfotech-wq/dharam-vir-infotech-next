...
import { Mail, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const EmailMarketing = () => (<PromotionServiceTemplate title="Email Marketing" subtitle="Drive conversions with targeted email campaigns and automation." breadcrumb="Email Marketing" features={[
        { icon: Mail, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
