...
import { Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const AiAdOptimization = () => (<PromotionServiceTemplate title="AI Ad Optimization" subtitle="Optimize ad spend and performance with AI-driven strategies." breadcrumb="AI Ad Optimization" features={[
        { icon: Target, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
...
export default AiAdOptimization;
