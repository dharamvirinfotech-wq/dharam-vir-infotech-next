...
const ContentMarketing = () => (<PromotionServiceTemplate title="Content Marketing" subtitle="Create compelling content that attracts, engages, and converts." breadcrumb="Content Marketing" features={[
