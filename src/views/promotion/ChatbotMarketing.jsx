...
import { MessageSquare, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const ChatbotMarketing = () => (<PromotionServiceTemplate title="Chatbot Marketing" subtitle="Automate customer engagement with intelligent chatbot solutions." breadcrumb="Chatbot Marketing" features={[
        { icon: MessageSquare, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
