...
import { Brain, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const PredictiveMarketing = () => (<PromotionServiceTemplate title="Predictive Marketing" subtitle="Anticipate customer behavior with predictive AI models." breadcrumb="Predictive Marketing" features={[
        { icon: Brain, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
