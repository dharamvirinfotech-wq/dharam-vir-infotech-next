...
import { TrendingUp, Target, BarChart3, Settings, Users, Shield } from "lucide-react";
const OrganicSeo = () => (<PromotionServiceTemplate title="Organic SEO Services" subtitle="Sustainable organic growth strategies that deliver long-term results." breadcrumb="Organic SEO Services" features={[
        { icon: TrendingUp, title: "Strategy Development", desc: "Custom strategies tailored to your business goals and target audience." },
